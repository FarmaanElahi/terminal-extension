...
export const defaultColumns: Array<ColDef<Symbol>> = [
  ...
  {
    field: "c/avgc126",
    headerName: "Close / Avg Close (126)",
    cellDataType: "number" satisfies CellDataType,
    context: { category: "Technicals" },
  },
  {
    field: "c25/avgc126__25",
    headerName: "Close / Avg Close (126) 25D Ago",
    cellDataType: "number" satisfies CellDataType,
    context: { category: "Technicals" },
  },
  {
    field: "c50/avgc126__50",
...
export function SymbolCell(props: FormattedValueProps) {
  ...
  return (
    <div className="inline-flex justify-start items-center gap-2 align-middle">
      <img
        src={[`${import.meta.env.VITE_LOGO_BASE_URL}`, `${logo}.svg`].join("/")}
        alt="Logo"
        width={16}
        height={16}
...
export function VolumeCell(props: VolumeCellProps) {
  ...
  return (
    <div className={cn("inline-flex gap-1", { "": bold })}>
      <span
